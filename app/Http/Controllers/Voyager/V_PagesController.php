...
class V_PagesController extends VoyagerBaseController
{
    ...
    public function show(Request $request, $id)
    {
        ...
        // podaci o PAGE
        $pageDATA = DB::table('pages as PAG')
                        ->join('users as USR','USR.id','PAG.author_id')
                        ->where('PAG.id',$id)
                        ->select(
                            'PAG.id as pag_id',
                            'PAG.author_id as pag_author_id',
                            'PAG.title as pag_title',
                            'PAG.excerpt as pag_excerpt',
                            'PAG.body as pag_body',
                            'PAG.image as pag_image',
                            'PAG.slug as pag_slug',
                            'PAG.meta_description as pag_meta_description',
                            'PAG.meta_keywords as pag_meta_keywords',
                            'PAG.status as pag_status',
                            'PAG.created_at as pag_created_at',
                            'PAG.updated_at as pag_updated_at',
