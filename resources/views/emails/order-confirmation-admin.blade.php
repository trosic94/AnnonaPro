			...
			<table cellpadding="0" cellspacing="0" width="90%" align="center">
				<tr>
					...
					@else
						...
						@lang('shop.email_other_payment_intro_note_admin_3') <a href="{{ $url }}/storage/proforma-invoice/{{ $order['proforma_invoice'] }}.pdf" target="_blank" style="text-decoration: none; color: #389178; font-weight: bold;">@lang('shop.email_other_payment_intro_link')</a>.<br>
					@endif
					<br>
