			...
			<table cellpadding="0" cellspacing="0" width="600" align="center">
				<tr>
					...
					@else
						...
						@lang('shop.email_other_payment_intro_note_3') <a href="{{ $url }}/storage/proforma-invoice/{{ $order['proforma_invoice'] }}.pdf" target="_blank" style="text-decoration: none; color: #0DACD2; font-weight: bold;">@lang('shop.email_other_payment_intro_link')</a>.<br>
					@endif
					<br>
					...
					<br>
					<br>
					@lang('shop.email_order_more_info') <a href="{{ $url }}/profil" target="_blank" style="text-decoration: none; color: #0DACD2; font-weight: bold;">@lang('shop.email_order_more_info_link')</a>.<br>
					<br>
