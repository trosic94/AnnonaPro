			...
			<table cellpadding="0" cellspacing="0" width="90%" align="center">
				<tr>
					...
					@else
						...
						@lang('shop.email_other_payment_intro_note_3') <a href="{{ $url }}/storage/proforma-invoice/{{ $order['proforma_invoice'] }}.pdf" target="_blank" style="text-decoration: none; color: #389178; font-weight: bold;">@lang('shop.email_other_payment_intro_link')</a>.<br>
					@endif
					<br>
					<table width="100%" cellpadding="0" cellspacing="0">
						<thead>
							<tr bgcolor="#389178">
								...
								<th style="padding: 3px; color: #ffffff;">@lang('shop.email_product_tbl_price_with_vat') ({{ setting('site.valuta') }})</th>
							</tr>
						</thead>
						<tbody>
					...
					<br>
					<br>
					@lang('shop.email_order_more_info') <a href="{{ $url }}/profil" target="_blank" style="text-decoration: none; color: #389178; font-weight: bold;">@lang('shop.email_order_more_info_link')</a>.<br>
					<br>
