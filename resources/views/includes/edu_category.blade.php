...
@foreach($navCategory as $navCategory1)
	<div id="lefNav" class="accordion modified-accordion p-0 mb-2">
	  {{-- <div class="card bg-white  border-0"> --}}
	    <div class="cardHead text-primary p-0 bg-white  border-0" id="headingOne">
	    ...
	    <div id="collapse{{$navCategory1['name']}}" class="collapse show " aria-labelledby="headingOne">
	      {{-- <div class="card-body p-0 pb-3"> --}}
	      		<ul id="catNAV" class="pt-2">
					@foreach($navCategory1['posts'] as $post)
						<li >
							<a class="streched-link" href="edukacija/{{ $post['slug'] }}">{{ $post['title'] }}</a>
						</li>
					@endforeach
				</ul>
	  	  {{-- </div> --}}
